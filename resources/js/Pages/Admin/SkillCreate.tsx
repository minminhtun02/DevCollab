                ...
                <div className="mx-auto max-w-xl space-y-6">
                    ...
                    <Card>
                        <CardContent className="space-y-4 pt-6">
                            ...
                            <Button className="w-full" disabled={saveMutation.isPending || !form.category_id} onClick={() => saveMutation.mutate()}>
                                {saveMutation.isPending ? t('common.saving') : t('skills.create')}
                            </Button>
                        </CardContent>
                    </Card>
                </div>
